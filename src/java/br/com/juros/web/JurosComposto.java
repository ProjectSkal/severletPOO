...
public class JurosComposto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<input type=\"number\" style=\"width:300px;\" class=\"form-control\" id=\"valorInicial\" \">");
            out.println("<label for=\"valormensal\">Depósito mensal</label>");
            out.println("<input type=\"number\" style=\"width:300px;\" class=\"form-control\" id=\"depositoMensal\" \">");
            out.println("<label for=\"valorInicial\">Taxa de juros mensal(%)</label>");
            out.println("<input type=\"number\" style=\"width:300px;\" class=\"form-control\" id=\"taxaJuros\" \">");
            out.println("<label for=\"valorInicial\">Período(mês)</label>");
            out.println("<input type=\"number\" style=\"width:300px;\" class=\"form-control\" id=\"período\" \">");
            out.println("<a style=\"margin-left:0px;\"; href=montante-juros-composto class=btn>Submit</a>");            
            out.println("</form>");
            out.println("</body>");
            out.println("</html>");
        }
