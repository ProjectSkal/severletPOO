...
public class JurosComposto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<li><a href=#>Juros Compostos</a></li>");
            out.println("</ul>");   
            ...
            out.println("<label for=\"valorInicial\"><span class=\"text-danger\">* </span>Valor inicial (R$)</label>");
            out.println("<input type=\"number\" style=\"width:300px;\" step=\"any\" class=\"form-control\" name=\"valorInicial\" required></br>");
