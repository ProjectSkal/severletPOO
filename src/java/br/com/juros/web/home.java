...
public class home extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<p>Matusalém Andrade dos Santos </p><br/>");
            out.println("<div class=\"d-flex justify-content-center\">");
            out.println("<a href='index.html' class=\"btn btn-outline-success\">Voltar</a> &nbsp");
            out.println("<a href=juros-simples class=\"btn btn-outline-success\">Juros Simples</a> &nbsp");
            out.println("<a href=juros-composto class=\"btn btn-outline-success\">Juros Compostos</a>");
            out.println("</div>");
            out.println("</div>");
            out.println("</body>");
            out.println("</html>");
